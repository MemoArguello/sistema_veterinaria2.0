...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Image("../img/proveedor.png", 60, 10, 10);
...
foreach ($proveedores as $proveedor) {
    // ID
    $pdf->Cell(40, 5, $proveedor->id_proveedor, 1, 0, "C");
    $pdf->Cell(75, 5, utf8_decode($proveedor->nombre_proveedor), 1, 0, "C");
    $pdf->Cell(75, 5, utf8_decode($proveedor->ruc_proveedor), 1, 0, "C");
